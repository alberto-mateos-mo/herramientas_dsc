...
- Sensibilidad a la partición inicial: como el algoritmo consiste de una búsqueda local, entonces el algoritmo es muy sensible a la selección inicial de clusters.
